    ...
    ) : IJobListener
{
    ...
    public async Task JobToBeExecuted(IJobExecutionContext context, CancellationToken cancellationToken = default)
    {
        ...
        using var unitOfWork = scopeFactory.ServiceProvider.GetService<IFirstUnitOfWork>();
    ...
    private static CreateJobLogDto GetJobLog(IJobExecutionContext context, string statusId, JobExecutionException? jobException = null)
    {
